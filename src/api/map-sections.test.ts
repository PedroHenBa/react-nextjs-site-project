...
describe('map-sections', () => {
  ...
  it('should test sections with invalid data', () => {
    mapSections([{ __component: 'section.section-content' }]);
    mapSections([{}]);
  });

  it('should test sections with invalid data', () => {
    mapSections([{ __component: 'section.section-grid', text_grid: [{}] }]);
    mapSections([{ __component: 'section.section-grid', image_grid: [{ image: [{}] }] }]);
  });
